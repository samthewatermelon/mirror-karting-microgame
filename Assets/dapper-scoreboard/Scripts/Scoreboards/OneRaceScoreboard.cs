...
{
    public class OneRaceScoreboard : NetworkBehaviour
    {
        ...
        public static OneRaceScoreboard singleton;
        ...
        {           
            ...
            List<JSON> list = jarray.ToList().OrderBy(o => o.GetInt("entryScore")).ToList<JSON>();//ByDescending(o => o.GetInt("entryScore")).ToList<JSON>();
