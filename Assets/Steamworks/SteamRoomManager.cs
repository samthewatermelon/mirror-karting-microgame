...
public class SteamRoomManager : NetworkManager
{
    ...
    public SteamRoomPlayer roomPlayerPrefab;
    ...
    public List<SteamRoomPlayer> roomSlots = new List<SteamRoomPlayer>();
    ...
    public void ReadyStatusChanged()
    {
        ...
        foreach (SteamRoomPlayer item in roomSlots)
        {
            if (item != null)
            {
                CurrentPlayers++;
    ...
    public override void OnServerReady(NetworkConnectionToClient conn)
    {
        ...
        if (conn != null && conn.identity != null)
        {
            ...
            if (roomPlayer != null && roomPlayer.GetComponent<SteamRoomPlayer>() != null)
    ...
    /// <para>If all of the players are ready, then the server switches from the RoomScene to the PlayScene, essentially starting the game. This is called automatically in response to SteamRoomPlayer.CmdChangeReadyState.</para>
    /// </summary>
    public void CheckReadyToBegin()
    {
        ...
        int numberOfReadyPlayers = NetworkServer.connections.Count(conn => conn.Value != null && conn.Value.identity.gameObject.GetComponent<SteamRoomPlayer>().readyToBegin);
    ...
    {
        OnRoomClientEnter();
        foreach (SteamRoomPlayer player in roomSlots)
            if (player != null)
            {
    ...
    public override void OnServerDisconnect(NetworkConnectionToClient conn)
    {
        ...
        {
            SteamRoomPlayer roomPlayer = conn.identity.GetComponent<SteamRoomPlayer>();
            ...
            {
                roomPlayer = clientOwnedObject.GetComponent<SteamRoomPlayer>();
                if (roomPlayer != null)
                    roomSlots.Remove(roomPlayer);
            }
        }
        ...
        {
            if (player != null)
                player.GetComponent<SteamRoomPlayer>().readyToBegin = false;
        }
    ...
    public override void OnServerAddPlayer(NetworkConnectionToClient conn)
    {
        ...
        if (IsSceneActive(RoomScene))
        {
            ...
            var playerInfoDisplay = conn.identity.GetComponent<SteamRoomPlayer>();
    ...
    public override void ServerChangeScene(string newSceneName)
    {
        ...
        {
            foreach (SteamRoomPlayer roomPlayer in roomSlots)
            {
                if (roomPlayer == null)
                    continue;
                ...
                if (NetworkServer.active)
                {
                    ...
                    roomPlayer.GetComponent<SteamRoomPlayer>().readyToBegin = false;
